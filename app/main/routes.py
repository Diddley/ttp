...
def index():
    ...
    cohorts = Cohort.query.filter(Cohort.coh_startDate<=today, Cohort.coh_endDate==None).order_by(Cohort.coh_startDate.asc()).paginate(page, current_app.config['POSTS_PER_PAGE'], False)
